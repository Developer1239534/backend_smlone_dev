...
// 1. POST /login - Trainee Login (Student ID & Password)
...
// 2. POST /forgot-password - Generate Reset Token / OTP Code
router.post('/forgot-password', async (req, res) => {
  try {
    ...
    return res.json({
      ...
      expires_in: '15 menit',
      instructions: 'Gunakan reset_token ini pada endpoint reset-password'
    });
  } catch (error) {
...
// 4. POST /change-password - Change Password directly
