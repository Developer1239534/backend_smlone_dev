...
async function main() {
  ...
  const res = await db.query('SELECT id, trainee_id, name, report_title, link_yt, report_title_2, link_term, link_terms, report_title_3, link_to_report, link_reports_3, report_title_4, referral_code FROM report_trainee ORDER BY id ASC');
