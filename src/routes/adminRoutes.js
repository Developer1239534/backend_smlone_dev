...
// 12. GET /admin/news - Get all news
...
// 13. POST /admin/news - Create news
router.post('/news', async (req, res) => {
  ...
  try {
    ...
    console.error('[Admin] POST News error:', err.message);
    res.status(500).json({ success: false, message: 'Server error.' });
  }
});

// 14. PUT /admin/news/:id - Edit news
router.put('/news/:id', async (req, res) => {
  ...
  try {
    ...
    console.error('[Admin] PUT News error:', err.message);
    res.status(500).json({ success: false, message: 'Server error.' });
  }
});

// 15. DELETE /admin/news/:id - Delete news
