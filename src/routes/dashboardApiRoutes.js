...
router.get('/profile/:id', async (req, res) => {
  ...
  res.json({
    ...
    data: {
      ...
      class_branch: trainee.class_branch,
      cabang: trainee.cabang,
      level: trainee.level,
      house_sml: trainee.house_sml,
      house_role: trainee.house_role,
      membership_expiry: trainee.membership_expiry,
      first_enroll: trainee.first_enroll,
      newest_grade: trainee.newest_grade,
      screening_test: trainee.screening_test,
      draft_grade: trainee.draft_grade,
      prev_grade: trainee.prev_grade,
      ss_hub: trainee.ss_hub,
      last_life_project_date: trainee.last_life_project_date,
      last_life_project: trainee.last_life_project,
      tautan_tambahan: trainee.tautan_tambahan,
