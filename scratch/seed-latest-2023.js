...
async function main() {
  try {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (!line) continue;
      if (line.startsWith('<USER_REQUEST>') || line.startsWith('</USER_REQUEST>') || line.startsWith('ini ya data periode 2023')) continue;
    ...
    console.log(`\n===========================================`);
    console.log(`   2023 BATCH 1 SEEDING COMPLETED`);
    console.log(`===========================================`);
