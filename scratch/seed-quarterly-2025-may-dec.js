...
const dataFilePath = path.join(__dirname, 'full-user-prompt-2025-may-dec.txt');
...
async function main() {
  try {
    ...
    console.log(`Parsed ${records.length} unique quarterly report records for May-Dec 2025.`);
    ...
    console.log(`\n=======================================`);
    console.log(`  MAY-DEC 2025 REPORT SEEDING COMPLETED`);
    console.log(`=======================================`);
