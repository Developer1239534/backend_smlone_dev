...
const dataFilePath = path.join(__dirname, 'request-2023-b4.txt');
...
async function main() {
  try {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (!line) continue;
      if (line.startsWith('<USER_REQUEST>') || line.startsWith('</USER_REQUEST>') || line.includes('jika ada ID tidak ada')) continue;
    ...
    console.log(`\n===========================================`);
    console.log(`   2023 BATCH 4 SEEDING COMPLETED`);
    console.log(`===========================================`);
