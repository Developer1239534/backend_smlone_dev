...
const dataFilePath = path.join(__dirname, 'user-prompt-2025.txt');
...
async function main() {
  try {
    ...
    console.log(`Parsed ${records.length} unique quarterly report records for 2025.`);
    ...
    console.log(`\n=======================================`);
    console.log(`    2025 REPORT SEEDING COMPLETED      `);
    console.log(`=======================================`);
