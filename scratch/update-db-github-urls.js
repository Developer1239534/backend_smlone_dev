...
async function main() {
  ...
  const updates = [
    { title: 'REAL STAGE: How to Join', url: `${baseUrl}/real-stage.jpg` },
    { title: 'Parents Trainer Meeting', url: `${baseUrl}/ptm.png` },
    { title: 'Jumat Produktif Bersama SMLONE', url: `${baseUrl}/jumat-produktif.jpg` },
    { title: 'Future Leaders Camp 2026', url: `${baseUrl}/flc.png` },
    { title: 'Lantern & Legends Holiday Camp', url: `${baseUrl}/lantern.png` }
  ];
