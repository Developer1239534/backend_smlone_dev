...
const dataFilePath = path.join(__dirname, 'additional-user-prompt-2024.txt');
...
async function main() {
  try {
    ...
    console.log(`Parsed ${records.length} unique additional quarterly report records for 2024.`);
    ...
    console.log(`\n=======================================`);
    console.log(`  ADDITIONAL REPORT SEEDING COMPLETED  `);
    console.log(`=======================================`);
